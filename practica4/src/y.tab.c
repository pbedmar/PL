...
{
       0,   376,   376,   378,   380,   382,   387,   392,   393,   395,
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4:
#line 380 "src/practica4.y"
                         { TS_InsertaMARCA(); }
#line 1806 "src/y.tab.c"
    break;

  case 5:
#line 386 "src/practica4.y"
                   { TS_VaciarENTRADAS(); }
#line 1812 "src/y.tab.c"
    break;

  case 6:
#line 390 "src/practica4.y"
                   { TS_VaciarENTRADAS(); }
...
#line 1848 "src/y.tab.c"
  ...
  case 12:
#line 398 "src/practica4.y"
                                                         { TS_InsertaPARAM_POR_DEF(yyvsp[-2].lexema, yyvsp[-2].tipo); }
#line 1854 "src/y.tab.c"
    break;

  case 13:
#line 400 "src/practica4.y"
...
#line 571 "src/practica4.y"
              ...
              } else if (yyvsp[-2].tipo == entero && yyvsp[0].tipo == lista_entero && yyvsp[-1].atrib == 0) {
                yyval.tipo = lista_entero;
              } else if (yyvsp[-2].tipo == real && yyvsp[0].tipo == lista_real && yyvsp[-1].atrib == 0) {
                yyval.tipo = lista_real;
              } else {
                errorTipoOperador(yyvsp[-1].lexema);
              }
