...
{
       0,  1007,  1007,  1011,  1015,  1021,  1042,  1059,  1067,  1074,
    1084,  1092,  1103,  1112,  1121,  1125,  1130,  1136,  1141,  1161,
    1163,  1171,  1181,  1191,  1204,  1209,  1214,  1227,  1236,  1248,
    1257,  1265,  1267,  1270,  1273,  1295,  1298,  1305,  1314,  1318,
    1349,  1360,  1369,  1382,  1390,  1399,  1424,  1445,  1454,  1475,
    1490,  1510,  1515,  1520,  1523,  1527,  1539,  1555,  1572,  1594,
    1613,  1631,  1639,  1647,  1655,  1668,  1676,  1721,  1729,  1737,
    1815,  1838,  1858,  1877,  1889,  1900,  1913,  1921,  1943,  1945,
    1971,  1973,  1975,  1992
};
#endif
...
#line 1025 "src/practica5.y"
                    { 
                      ...
                      yyval.codigoGlobal = (char*)malloc(strlen(yyvsp[-3].codigoGlobal) + 1);
                      strcpy(yyval.codigoGlobal,yyvsp[-3].codigoGlobal);

                      yyval.codigo = (char*)malloc(strlen(yyvsp[-4].codigo) + strlen(yyvsp[-3].codigo) + strlen(yyvsp[-2].codigo) + strlen(yyvsp[-1].codigo) + strlen(tab) + strlen("}\n") + 1);
                      strcpy(yyval.codigo,yyvsp[-4].codigo);
                      strcat(yyval.codigo,yyvsp[-3].codigo);
...
#line 1059 "src/practica5.y"
                                                      { 
                                                        ...
                                                        yyval.codigo = (char*)malloc(strlen(yyvsp[-2].codigo) + strlen(", ") + strlen(yyvsp[0].codigo) + 1);
...
#line 2500 "src/y.tab.c"
  ...
  case 9:
#line 1074 "src/practica5.y"
                                                                                { 
                            TS_InsertaPARAM_POR_DEF(yyvsp[-2].lexema, yyvsp[-2].tipo); 

                            yyval.codigo = (char*)malloc(strlen(yyvsp[-4].codigo) + strlen(", ") + strlen(yyvsp[-2].codigo) + strlen(" = ") + strlen(yyvsp[0].lexema) + 1);
                            strcpy(yyval.codigo, yyvsp[-4].codigo);
                            strcat(yyval.codigo, ", ");
                            strcat(yyval.codigo, yyvsp[-2].codigo);
                            strcat(yyval.codigo, " = ");
...
#line 2515 "src/y.tab.c"
  ...
  case 10:
#line 1084 "src/practica5.y"
                                                    { 
                                                      TS_InsertaPARAM_POR_DEF(yyvsp[-2].lexema, yyvsp[-2].tipo); 

                                                      yyval.codigo = (char*)malloc(strlen(yyvsp[-2].codigo) + strlen(" = ") + strlen(yyvsp[0].lexema));
                                                      strcat(yyval.codigo, yyvsp[-2].codigo);
                                                      strcat(yyval.codigo, " = ");
                                                      strcat(yyval.codigo, yyvsp[0].lexema);
                                                    }
#line 2528 "src/y.tab.c"
    break;

  case 11:
#line 1092 "src/practica5.y"
                                                                                      { 
                                                                                        TS_InsertaPARAM_POR_DEF(yyvsp[-2].lexema, yyvsp[-2].tipo); 

                                                                                        yyval.codigo = (char*)malloc(strlen(yyvsp[-4].codigo) + strlen(", ")
                                                                                        + strlen(yyvsp[-2].codigo) + strlen(" = ") + strlen(yyvsp[0].codigo) + 1);
                                                                                        strcpy(yyval.codigo, yyvsp[-4].codigo);
                                                                                        strcat(yyval.codigo, ", ");
                                                                                        strcat(yyval.codigo, yyvsp[-2].codigo);
                                                                                        strcat(yyval.codigo, " = ");
...
#line 1103 "src/practica5.y"
                                                          { 
                                                            ...
                                                            yyval.codigo = (char*)malloc(strlen(yyvsp[-2].codigo) + strlen(" = ") + strlen(yyvsp[0].codigo));
                                                            strcat(yyval.codigo, yyvsp[-2].codigo);
                                                            strcat(yyval.codigo, " = ");
                                                            strcat(yyval.codigo, yyvsp[0].codigo);
                                                          }
#line 2557 "src/y.tab.c"
  ...
  case 13:
#line 1112 "src/practica5.y"
                        { 
                          yyval.tipo = tipoTmp; yyval.lexema = yyvsp[0].lexema; 

                          yyval.codigo = (char*)malloc(strlen(yyvsp[-1].codigo) + strlen(" ") + strlen(yyvsp[0].lexema) + 1);
...
#line 2693 "src/y.tab.c"
    break;

  case 24:
#line 1204 "src/practica5.y"
                                                            {
                                                              yyval.codigo = (char*)malloc(strlen(yyvsp[-1].codigo) + strlen(yyvsp[0].codigo) + 1);
                                                              strcpy(yyval.codigo, yyvsp[-1].codigo);
                                                              strcat(yyval.codigo, yyvsp[0].codigo);
...
#line 2712 "src/y.tab.c"
  ...
  case 26:
#line 1214 "src/practica5.y"
                                        { 
                                          Subprog = 0; 

                                          char *tab = generarTab();
                                          yyval.codigo = (char*)malloc(strlen(tab) + strlen(yyvsp[-1].codigo) + strlen("\n") + strlen(yyvsp[0].codigo) + strlen(tab) + strlen(";\n\n") + 1);
                                          strcpy(yyval.codigo, tab);
                                          strcat(yyval.codigo, yyvsp[-1].codigo);
                                          strcat(yyval.codigo, "\n");
                                          strcat(yyval.codigo, yyvsp[0].codigo);
...
#line 2729 "src/y.tab.c"
  ...
  case 27:
#line 1227 "src/practica5.y"
                                      { 
                                        TS_InsertaPROCED(yyvsp[0].lexema); 

                                        yyval.codigo = (char*)malloc(strlen("auto ") + strlen(yyvsp[0].lexema) + strlen("= [=] ") + 1);
...
#line 2742 "src/y.tab.c"
  ...
  case 28:
#line 1236 "src/practica5.y"
                                                                                                { 
                                                                                                  Subprog = 1; 

                                                                                                  yyval.codigo = (char*)malloc(strlen(yyvsp[-5].codigo) + strlen(" (") + strlen(yyvsp[-3].codigo)
                                                                                                                     + strlen(", ") + strlen(yyvsp[-1].codigo) + strlen(") ") + 1);
                                                                                                  strcpy(yyval.codigo, yyvsp[-5].codigo);
                                                                                                  strcat(yyval.codigo, " (");
                                                                                                  strcat(yyval.codigo, yyvsp[-3].codigo);
                                                                                                  strcat(yyval.codigo, ", ");
                                                                                                  strcat(yyval.codigo, yyvsp[-1].codigo);
...
#line 2759 "src/y.tab.c"
  ...
  case 29:
#line 1248 "src/practica5.y"
                                                                    { 
                                                                      Subprog = 1; 

                                                                      yyval.codigo = (char*)malloc(strlen(yyvsp[-3].codigo) + strlen("(") + strlen(yyvsp[-1].codigo) + strlen(")") + 1);
                                                                      strcpy(yyval.codigo, yyvsp[-3].codigo);
                                                                      strcat(yyval.codigo, "(");
                                                                      strcat(yyval.codigo, yyvsp[-1].codigo);
                                                                      strcat(yyval.codigo, ")");
                                                                    }
#line 2773 "src/y.tab.c"
    break;

  case 30:
#line 1257 "src/practica5.y"
                                                    { 
                                                      Subprog = 1; 

                                                      yyval.codigo = (char*)malloc(strlen(yyvsp[-2].codigo) + strlen(" (") + strlen(") ") + 1);
                                                      strcpy(yyval.codigo, yyvsp[-2].codigo);
                                                      strcat(yyval.codigo, " (");
                                                      strcat(yyval.codigo, ") ");
                                                    }
...
#line 2826 "src/y.tab.c"
  ...
  case 35:
#line 1295 "src/practica5.y"
                     {  yyval.codigo = (char*)malloc(strlen(yyvsp[0].codigo) + 1);
                        strcpy(yyval.codigo,yyvsp[0].codigo);
                     }
#line 2834 "src/y.tab.c"
    break;

  case 36:
#line 1298 "src/practica5.y"
                                   { char *tab = generarTab();
...
#line 2860 "src/y.tab.c"
    break;

  case 38:
#line 1315 "src/practica5.y"
            {
              bucleWhile(&yyval,&yyvsp[-4],&yyvsp[-3],&yyvsp[-2],&yyvsp[-1],&yyvsp[0]);
            }
#line 2868 "src/y.tab.c"
    break;
...
#line 1319 "src/practica5.y"
                                  { char *tab = generarTab();
                                    ...
                                    strcpy(yyval.codigo,tab);
                                    strcat(yyval.codigo,"{\n");
                                    strcat(yyval.codigo,yyvsp[-4].codigo);
                                    strcat(yyval.codigo,tab);
                                    strcat(yyval.codigo,"{\n");
                                    strcat(yyval.codigo,yyvsp[0].codigo);
                                    strcat(yyval.codigo,yyvsp[-2].codigo);
...
#line 2903 "src/y.tab.c"
  ...
  case 40:
#line 1349 "src/practica5.y"
                                              {
                                                char *tab = generarTab();
                                                yyval.codigo = (char*)malloc(strlen(tab) + strlen("{\n") + strlen(yyvsp[-1].codigo) + strlen(tab) + strlen("}\n\n") + 1);
                                                strcpy(yyval.codigo,tab);
                                                strcat(yyval.codigo,"{\n");
                                                strcat(yyval.codigo,yyvsp[-1].codigo);
                                                strcat(yyval.codigo,"\n");
...
#line 2918 "src/y.tab.c"
    break;

  case 41:
#line 1360 "src/practica5.y"
                                    {
                                      char *tab = generarTab();
                                      yyval.codigo = (char*)malloc(strlen(tab) + strlen("{\n") + strlen(yyvsp[-1].codigo) + strlen(tab) + strlen("}\n\n") + 1);
                                      strcpy(yyval.codigo, tab);
...
#line 2932 "src/y.tab.c"
    break;

  case 42:
#line 1369 "src/practica5.y"
                              {
                                char *tab = generarTab();
                                yyval.codigo = (char*)malloc(strlen(tab) + strlen("{\n") + strlen(yyvsp[0].codigoProced) + strlen(tab) 
                                + strlen(yyvsp[0].codigo) + strlen("\n") + strlen(tab) + strlen("}\n\n") + 1);
                                strcpy(yyval.codigo,tab);
                                strcat(yyval.codigo,"{\n");
                                strcat(yyval.codigo,yyvsp[0].codigoProced);
                                strcat(yyval.codigo,tab);
                                strcat(yyval.codigo,yyvsp[0].codigo);
                                strcat(yyval.codigo,"\n");
                                strcat(yyval.codigo,tab);
...
#line 2950 "src/y.tab.c"
    break;

  case 43:
#line 1382 "src/practica5.y"
...
#line 2963 "src/y.tab.c"
    break;

  case 44:
#line 1390 "src/practica5.y"
                            {yyvsp[-1].tipo = buscarTipoVariable(yyvsp[-1].lexema);
                              if (esLista(yyvsp[-1].tipo)) { 
                                yyval.tipo = yyvsp[-1].tipo; 
                                genCodComienzoLista(&yyval, &yyvsp[-1]);
                              } else {
                                errorTipoOperador(yyvsp[-2].lexema);
                              }
                            }
#line 2976 "src/y.tab.c"
    break;

  case 45:
#line 1399 "src/practica5.y"
                                               {
...
#line 3005 "src/y.tab.c"
    break;

  case 46:
#line 1424 "src/practica5.y"
                                         { char *etiqSalida = etiqueta();
...
#line 3030 "src/y.tab.c"
    break;

  case 47:
#line 1445 "src/practica5.y"
                                        { descriptorDeInstrControl descrip = buscarDescrip();
...
#line 1475 "src/practica5.y"
                                                        {
                                                          ...
                                                          + strlen(etiqPrintf) + strlen("\", &") + strlen(yyvsp[0].lexema) + strlen("); getchar();\n") + 1);
                                                          strcpy(yyval.codigo, yyvsp[-2].codigo);
                                                          strcat(yyval.codigo, tab);
...
#line 3088 "src/y.tab.c"
    break;

  case 50:
#line 1490 "src/practica5.y"
                             {  
...
#line 3122 "src/y.tab.c"
    break;

  case 52:
#line 1515 "src/practica5.y"
                      {
                        yyval.codigo = (char*)malloc(strlen(yyvsp[0].codigo) + 1);
                        strcpy(yyval.codigo,yyvsp[0].codigo);
                      }
#line 3131 "src/y.tab.c"
    break;

  case 53:
#line 1520 "src/practica5.y"
                    { 
                      generarCodMensajeExp(&yyval, &yyvsp[0]);
                    }
#line 3139 "src/y.tab.c"
    break;

  case 54:
#line 1523 "src/practica5.y"
                 {
                    generarCodMensajeCad(&yyval, &yyvsp[0]);
                  }
#line 3147 "src/y.tab.c"
    break;

  case 55:
#line 1527 "src/practica5.y"
                           { yyval.lexema = yyvsp[-1].lexema ;
                             ...
                             yyval.codigo = (char*)malloc(strlen(yyvsp[-1].lexema) + strlen("(") + 1);
                             strcpy(yyval.codigo, yyvsp[-1].lexema);
                             strcat(yyval.codigo, "("); 
                            }
#line 3163 "src/y.tab.c"
    break;

  case 56:
#line 1539 "src/practica5.y"
                                                              { if(posProced != -1) {
                                                                ...
                                                                yyval.codigo = (char*)malloc(strlen(yyvsp[-3].codigo) + strlen(yyvsp[-2].codigo) + strlen(");") + 1);
                                                                yyval.codigoProced = (char*)malloc(strlen(yyvsp[-2].codigoProced) + 1);
                                                                strcpy(yyval.codigoProced, yyvsp[-2].codigoProced);
                                                                strcpy(yyval.codigo, yyvsp[-3].codigo);
                                                                strcat(yyval.codigo, yyvsp[-2].codigo);
                                                                strcat(yyval.codigo, ");");
                                                              }
#line 3184 "src/y.tab.c"
    break;

  case 57:
#line 1555 "src/practica5.y"
                                            { if(posProced != -1) {
                                                if(posParam < TS[posProced].parametrosMin) {
                                              ...
                                              yyval.codigo = (char*)malloc(strlen(yyvsp[-2].codigo) + strlen(");") + 1);
                                              strcpy(yyval.codigo, yyvsp[-2].codigo);
                                              strcat(yyval.codigo, ");");
                                            }
#line 3205 "src/y.tab.c"
    break;

  case 58:
#line 1572 "src/practica5.y"
                                                       { if(yyval.tipo != yyvsp[0].tipo) {
                                                         ...
                                                         if(posProced != -1) {
                                                          ...
                                                          yyval.codigoProced = (char*)malloc(strlen(yyvsp[-2].codigoProced) + strlen(yyvsp[0].codigo) + strlen("\n") + 1);
                                                          strcpy(yyval.codigoProced, yyvsp[-2].codigoProced);
                                                          strcat(yyval.codigoProced, yyvsp[0].codigo);
                                                          strcat(yyval.codigoProced, "\n");

                                                          yyval.codigo = (char*)malloc(strlen(yyvsp[-2].codigo) + strlen(", ") + strlen(yyvsp[0].nombre) + 1);
                                                          strcpy(yyval.codigo, yyvsp[-2].codigo);
                                                          strcat(yyval.codigo, ", ");
                                                          strcat(yyval.codigo, yyvsp[0].nombre); 
                                                        }
#line 3232 "src/y.tab.c"
    break;

  case 59:
#line 1594 "src/practica5.y"
                                { yyval.tipo = yyvsp[0].tipo;
                                  ...
                                  yyval.codigoProced = (char*)malloc(strlen(yyvsp[0].codigo) + strlen("\n") + 1);
                                  strcpy(yyval.codigoProced, yyvsp[0].codigo);
                                  strcat(yyval.codigoProced, "\n");

                                  yyval.codigo = (char*)malloc(strlen(yyvsp[0].nombre) + 1);
                                  strcpy(yyval.codigo, yyvsp[0].nombre);  
                                }
#line 3255 "src/y.tab.c"
    break;

  case 60:
#line 1613 "src/practica5.y"
                                      { yyval.tipo = yyvsp[-1].tipo;
                                        yyval.lexema = yyvsp[-1].lexema;
                                        char *varTmp = temporal();
                                        char *tipoTmp = obtenerTipo(yyval.tipo);
                                        char *tab = generarTab();
                                        yyval.codigo = (char*)malloc(strlen(yyvsp[-1].codigo) + strlen(tab) + strlen(tipoTmp) + strlen(" ") + strlen(varTmp) + strlen(" = (") 
                                        + strlen(yyvsp[-1].nombre) + strlen(");\n") + 1);
                                        strcpy(yyval.codigo, yyvsp[-1].codigo);
                                        strcat(yyval.codigo, tab);
...
#line 3278 "src/y.tab.c"
    break;

  case 61:
#line 1631 "src/practica5.y"
                                  {
...
#line 3291 "src/y.tab.c"
    break;

  case 62:
#line 1639 "src/practica5.y"
                                  {
              if (esNumerico(yyvsp[0].tipo)){
                yyval.tipo = yyvsp[0].tipo;
                generarCodExpresionUnario(&yyval,&yyvsp[-1],&yyvsp[0],yyvsp[-1].lexema);
...
#line 3304 "src/y.tab.c"
    break;

  case 63:
#line 1647 "src/practica5.y"
                            {
...
#line 3317 "src/y.tab.c"
    break;

  case 64:
#line 1655 "src/practica5.y"
                                         {
              if (esLista(yyvsp[0].tipo)) {
                if (yyvsp[-1].atrib == 0) {
                  ...
                  genCodObtenerElementoActual(&yyval, &yyvsp[0]);
                }
              } else {
                errorTipoOperador(yyvsp[-1].lexema);
              }
            }
#line 3335 "src/y.tab.c"
    break;

  case 65:
#line 1668 "src/practica5.y"
                                               {
              if (esNumerico(yyvsp[0].tipo)){
                yyval.tipo = yyvsp[0].tipo;
                generarCodExpresionUnario(&yyval,&yyvsp[-1],&yyvsp[0],yyvsp[-1].lexema);
...
#line 1676 "src/practica5.y"
              ...
              if (yyvsp[-2].tipo == entero && yyvsp[0].tipo == entero) {
                ...
                if (yyvsp[-1].atrib == 0)
                  genCodSumarElementoALista(&yyval, &yyvsp[-2], &yyvsp[0]);
                else if (yyvsp[-1].atrib == 1)
                  genCodRestarElementoALista(&yyval, &yyvsp[-2], &yyvsp[0]);
                correcto = 2;
                ...
                if (yyvsp[-2].tipo == real && yyvsp[0].tipo == lista_real) {
                  yyval.tipo = lista_real;
                  genCodSumarElementoALista(&yyval, &yyvsp[0], &yyvsp[-2]);
                  correcto = 2;
...
#line 3398 "src/y.tab.c"
    break;

  case 67:
#line 1721 "src/practica5.y"
                                            {
              if (esLista(yyvsp[-2].tipo) && yyvsp[0].tipo == entero) {
                yyval.tipo = yyvsp[-2].tipo;
                genCodEliminarElementoPosicion(&yyval, &yyvsp[-2], &yyvsp[0]);
              } else {
                errorTipoOperador(yyvsp[-1].lexema);
              }
            }
#line 3411 "src/y.tab.c"
  ...
  case 68:
#line 1729 "src/practica5.y"
                                                                 {
              if(esLista(yyvsp[-2].tipo) && yyvsp[0].tipo == entero) {
                yyval.tipo = listaATipo(yyvsp[-2].tipo);
                genCodObtenerElementoPosicion(&yyval, &yyvsp[-2], &yyvsp[0]);
              } else {
                errorTipoOperador(yyvsp[-1].lexema);
              }
            }
#line 3424 "src/y.tab.c"
    break;

  case 69:
#line 1737 "src/practica5.y"
                                                  {
              int correcto = 0;
              if (yyvsp[-1].atrib == 0) {
                if (yyvsp[-2].tipo == entero && yyvsp[0].tipo == entero) {
                  ...
                  yyval.tipo = lista_entero;
                  genCodMultiplicarElementoALista(&yyval, &yyvsp[-2], &yyvsp[0]);
                  correcto = 2;
                } else if (yyvsp[-2].tipo == lista_real && yyvsp[0].tipo == real) {
                  yyval.tipo = lista_real;
                  genCodMultiplicarElementoALista(&yyval, &yyvsp[-2], &yyvsp[0]);
                  ...
                  yyval.tipo = lista_real;
                  genCodMultiplicarElementoALista(&yyval, &yyvsp[0], &yyvsp[-2]);
                  correcto = 2;
                } else if (yyvsp[-2].tipo == entero && yyvsp[0].tipo == lista_entero) {
                  yyval.tipo = lista_entero;
                  genCodMultiplicarElementoALista(&yyval, &yyvsp[0], &yyvsp[-2]);
                ...
                if (yyvsp[-2].tipo == entero && yyvsp[0].tipo == entero) {
                  ...
                  yyval.tipo = lista_entero;
                  genCodDividirElementoALista(&yyval, &yyvsp[-2], &yyvsp[0]);
                  correcto = 2;
                } else if (yyvsp[-2].tipo == lista_real && yyvsp[0].tipo == real) {
                  yyval.tipo = lista_real;
                  genCodDividirElementoALista(&yyval, &yyvsp[-2], &yyvsp[0]);
                ...
                if (yyvsp[-2].tipo == lista_entero && yyvsp[0].tipo == entero) {
                  yyval.tipo = lista_entero;
                  genCodEliminarListaAPartirPosicion(&yyval, &yyvsp[-2], &yyvsp[0]);
                  correcto = 2;
...
#line 3507 "src/y.tab.c"
    break;

  case 70:
#line 1815 "src/practica5.y"
                                            {
              int correcto = 0;
              if (yyvsp[-2].tipo == entero && yyvsp[0].tipo == entero) {
                yyval.tipo = entero;
                ...
                yyval.tipo = yyvsp[-2].tipo;
                genCodConcatenarListas(&yyval, &yyvsp[-2], &yyvsp[0]);
                correcto = 2;
              } else {
                errorTipoOperador(yyvsp[-1].lexema);
              }
...
#line 3560 "src/y.tab.c"
    break;

  case 72:
#line 1858 "src/practica5.y"
                                           { 
              int correcto = 0;
              if (yyvsp[-2].tipo == entero && yyvsp[0].tipo == entero) {
                yyval.tipo = booleano;
...
#line 3584 "src/y.tab.c"
    break;

  case 73:
#line 1877 "src/practica5.y"
                                     {
...
#line 3601 "src/y.tab.c"
    break;

  case 74:
#line 1889 "src/practica5.y"
                                      {
              if (yyvsp[-2].tipo == booleano && yyvsp[0].tipo == booleano) {
                yyval.tipo = booleano;
                generarCodExpresion(&yyval,&yyvsp[-2],&yyvsp[-1],&yyvsp[0],"&&");
...
#line 3617 "src/y.tab.c"
    break;

  case 75:
#line 1900 "src/practica5.y"
                                      {
              if (yyvsp[-2].tipo == booleano && yyvsp[0].tipo == booleano) {
                yyval.tipo = booleano;
                generarCodExpresion(&yyval,&yyvsp[-2],&yyvsp[-1],&yyvsp[0],"^");
...
#line 3675 "src/y.tab.c"
    break;

  case 78:
#line 1943 "src/practica5.y"
                             { yyval.tipo = yyvsp[0].tipo;
                               yyval.lexema = yyvsp[0].lexema; }
#line 3682 "src/y.tab.c"
    break;

  case 79:
#line 1945 "src/practica5.y"
                        { yyval.tipo = yyvsp[0].tipo;
                          if(yyvsp[0].tipo == booleano) {
...
#line 3713 "src/y.tab.c"
    break;

  case 81:
#line 1973 "src/practica5.y"
                                                      { yyval.tipo = yyvsp[-1].tipo; }
#line 3719 "src/y.tab.c"
    break;

  case 82:
#line 1975 "src/practica5.y"
...
#line 3764 "src/y.tab.c"
    break;


#line 3768 "src/y.tab.c"
